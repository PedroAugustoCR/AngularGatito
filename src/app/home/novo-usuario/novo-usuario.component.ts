...
import { usuarioSenhaIguaisValidator } from 'src/app/validators/usuarioSenhaIguaisValidator';
...
export class NovoUsuarioComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private NovoUsuarioService: NovoUsuarioService,
    private usuarioExistenteService: UsuarioExisteService, private router: Router) { }
